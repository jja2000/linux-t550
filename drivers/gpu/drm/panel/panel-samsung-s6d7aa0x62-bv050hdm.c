...
static int s6d7aa0x62_bv050hdm_on(struct s6d7aa0x62_bv050hdm *ctx)
{
	...
	dsi_dcs_write_seq(dsi, 0xb1, 0x12);
	dsi_dcs_write_seq(dsi, 0xb2, 0x14, 0x22, 0x2f, 0x18);
	dsi_dcs_write_seq(dsi, 0xb3, 0x11);
	dsi_dcs_write_seq(dsi, 0xba,
			  0x03, 0x19, 0x19, 0x11, 0x03, 0x05, 0x18, 0x18, 0x77);
	dsi_dcs_write_seq(dsi, 0xbc, 0x00, 0x4e, 0x0b);
	dsi_dcs_write_seq(dsi, 0xc0, 0x80, 0x80, 0x30);
	dsi_dcs_write_seq(dsi, 0xc1, 0x03);
	usleep_range(1000, 2000);
	dsi_dcs_write_seq(dsi, 0xc2, 0x00);
	usleep_range(10000, 11000);
	dsi_dcs_write_seq(dsi, 0xc3, 0x40, 0x00, 0x28);
	dsi_dcs_write_seq(dsi, 0xee,
			  0xa8, 0x00, 0x95, 0x00, 0xa8, 0x00, 0x95, 0x00);
	dsi_dcs_write_seq(dsi, 0xf2, 0x02, 0x10, 0x10, 0xc4, 0x80);
	dsi_dcs_write_seq(dsi, 0xf3,
			  0x01, 0x93, 0x20, 0x22, 0x80, 0x05, 0x25, 0x3c, 0x26,
			  0x00);
	dsi_dcs_write_seq(dsi, 0xf7,
			  0x01, 0x1b, 0x08, 0x0c, 0x09, 0x0d, 0x01, 0x01, 0x01,
			  0x04, 0x06, 0x01, 0x01, 0x00, 0x00, 0x1a, 0x01, 0x1b,
			  0x0a, 0x0e, 0x0b, 0x0f, 0x01, 0x01, 0x01, 0x05, 0x07,
			  0x01, 0x01, 0x00, 0x00, 0x1a);
	dsi_dcs_write_seq(dsi, 0xef,
			  0x34, 0x12, 0x98, 0xba, 0x10, 0x80, 0x24, 0x80, 0x80,
			  0x80, 0x00, 0x00, 0x00, 0x44, 0xa0, 0x82, 0x00);
	dsi_dcs_write_seq(dsi, 0xf6, 0x60, 0x25, 0x05, 0x00, 0x00, 0x03);
	...
	dsi_dcs_write_seq(dsi, 0xfa,
			  0x01, 0x3f, 0x09, 0x0c, 0x00, 0x01, 0x06, 0x04, 0x04,
			  0x0c, 0x10, 0x15, 0x16, 0x18, 0x1c, 0x20, 0x2a);
					 ...
					 struct drm_connector *connector)
{
	...
	mode = drm_mode_duplicate(connector->dev, &s6d7aa0x62_bv050hdm_mode);
	if (!mode)
		return -ENOMEM;
...
static int s6d7aa0x62_bv050hdm_remove(struct mipi_dsi_device *dsi)
{
...
MODULE_DESCRIPTION("DRM driver for S6D7AA0X62 BV050HDMdsi video mode panel");
